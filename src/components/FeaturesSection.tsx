...
const FEATURES = [
  {
    ...
    description:
      'Manage the entire system with no upfront costs or ongoing management required from your team.',
  },
  {
    icon: Clock,
    title: 'Available 24/7',
    description:
      'Residents can access on-demand drinks and snacks whenever they need them, day or night.',
  },
  {
    icon: Sparkles,
    title: 'Stylish & Modern',
    description:
      'Design compliments interiors with sleek, contemporary aesthetics that enhance your property.',
  },
  {
    icon: Heart,
    title: 'Curated Selection',
    description:
      "Local favorites and premium brands carefully selected to match your residents' preferences.",
  },
  {
    icon: Gift,
    title: 'Weekly Resident Raffle',
    description:
      '2% profit share raffle creates excitement and community engagement among residents.',
  },
  {
    icon: TrendingUp,
    title: 'Resident-Loved',
    description:
      'Our residents absolutely love it - especially the weekly giveaways and premium selection.',
  },
];
          ...
          <div className="bg-gradient-card p-8 rounded-2xl shadow-soft">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="bg-brand-teal text-white px-8 py-3 rounded-lg font-semibold hover:bg-brand-teal/90 transition-colors inline-block text-center"
              >
                Schedule Installation
              </Link>
              <Link
                to="/property-managers#callback"
                className="border-2 border-brand-teal text-brand-teal px-8 py-3 rounded-lg font-semibold hover:bg-brand-teal hover:text-white transition-colors inline-block text-center"
              >
                Request Callback
              </Link>
            </div>
